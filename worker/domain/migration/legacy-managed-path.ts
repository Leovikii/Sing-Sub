export type LegacyManagedKind = 'configs' | 'nodes' | 'templates' | 'patches' | 'rulesets';

const MANAGED_LEGACY_PATH = /^sing-sub\/(configs|nodes|templates|patches|rulesets)\/([a-zA-Z0-9][a-zA-Z0-9._-]{0,127})\.json$/;
