export type WorkspaceAssetKind = 'nodes' | 'templates' | 'adapters' | 'rulesets';

const MANAGED_ASSET_PATH = /^sing-sub\/(nodes|templates|adapters|rulesets)\/([a-zA-Z0-9][a-zA-Z0-9._-]{0,127})\.json$/;
